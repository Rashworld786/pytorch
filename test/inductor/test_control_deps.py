...
class TestControlDeps(InductorTestCase):
    ...
    def test_wait_event_threads_record_event_passthroughs(self):
        ...
        record = g.call_function(
            torch.ops.streams.record_event.default, args=(42, 19)
        )
        ...
        wait = g.call_function(
            torch.ops.streams.wait_event.default, args=(42, 0)
        )
        ...
        consumer = g.call_function(
            torch.ops.aten.add.Tensor, args=(reload, other)
        )
        ...
        self.assertNotIn(
            torch.ops.streams.record_event.default, subgraph_targets
        )
